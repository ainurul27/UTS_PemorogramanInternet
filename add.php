...
$connect  = new mysqli($server, $user, $password, $db);
    ...
    if ( $_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        do{
            ...
            $sql = "INSERT INTO t_sekolah (npsn, status, bentuk_pendidikan, nama_sekolah, sk_pendirian, tgl_pendirian, sk_izin_operasional, tgl_izin_operasional, alamat, rt, rw, dusun, desa, kecamatan, kabupaten_kota, provinsi, kode_pos)"
